...
public interface ChristmasMarketAssistant {
    ...
    @SystemMessage("""
            ...
            3. Use smart defaults: tomorrow evening, 2 people, their name or "Guest"

            NEVER invent locations, reference numbers, or booking confirmations. Only use data from tool responses.
